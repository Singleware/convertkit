...
__decorate([
    ...
    Class.Public()
], Create.prototype, "id", void 0);
__decorate([
    RestDB.Schema.Alias('account_id'),
    RestDB.Schema.Number(),
    Class.Public()
], Create.prototype, "accountId", void 0);
__decorate([
    RestDB.Schema.Required(),
    RestDB.Schema.Alias('created_at'),
    RestDB.Schema.Date(),
    Class.Public()
], Create.prototype, "createdAt", void 0);
__decorate([
    RestDB.Schema.Alias('updated_at'),
    RestDB.Schema.Date(),
    Class.Public()
], Create.prototype, "updatedAt", void 0);
__decorate([
    RestDB.Schema.Alias('delete_at'),
    RestDB.Schema.Date(),
    Class.Public()
], Create.prototype, "deletedAt", void 0);
__decorate([
    RestDB.Schema.Required(),
